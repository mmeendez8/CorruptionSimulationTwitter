...
for network_size in network_sizes:
    ...
    ##########################
    user_count = 0
    while (tovisit and count<network_size):
        # Searh followers
    ...
    with open('query_output'+str(network_size)+'.json', 'a') as jsonfile:
